...
var bs_datepicker_input_directive_BsDatepickerInputDirective = /** @class */ (function () {
    function BsDatepickerInputDirective(_picker, _localeService, _renderer, _elRef, changeDetection) {
        ...
        this._picker.dateInputFormat$.pipe(Object(operators_["distinctUntilChanged"])()).subscribe(function () {
            _this._setInputValue(_this._value);
        });
    }
...
var bs_datepicker_component_BsDatepickerDirective = /** @class */ (function () {
    function BsDatepickerDirective(_config, _elementRef, _renderer, _viewContainerRef, cis) {
        ...
        this._subs = [];
        this._dateInputFormat$ = new Subject_Subject();
...
var bs_daterangepicker_input_directive_BsDaterangepickerInputDirective = /** @class */ (function () {
    function BsDaterangepickerInputDirective(_picker, _localeService, _renderer, _elRef, changeDetection) {
        ...
        // update input value on format change
        this._picker.rangeInputFormat$.pipe(Object(operators_["distinctUntilChanged"])()).subscribe(function () {
            _this._setInputValue(_this._value);
        });
    }
...
var bs_daterangepicker_component_BsDaterangepickerDirective = /** @class */ (function () {
    function BsDaterangepickerDirective(_config, _elementRef, _renderer, _viewContainerRef, cis) {
        ...
        this.bsValueChange = new core_["EventEmitter"]();
        this._subs = [];
        this._rangeInputFormat$ = new Subject_Subject();
        this._datepicker = cis.createLoader(_elementRef, _viewContainerRef, _renderer);
        Object.assign(this, _config);
        this.onShown = this._datepicker.onShown;
        this.onHidden = this._datepicker.onHidden;
